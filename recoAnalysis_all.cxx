...
ofstream outputFile(argv[2],std::ofstream::out|std::ofstream::app);
...
sprintf(filename,"surfaceRunHist_numSurfaceEventsInRun_vnchnl3NoMasking_noMaskSat_snrMode1_coherenceThermalCut_snrCut_ch6Fit2Corr_2SurfaceCut_%s_fullData_type3.C", STATION.c_str());
c4.SaveAs(filename);
