...
*/
   ...
   /* A3 spikey D1 filter */
   if (isSpikeyStringEvent(statiodId, dropARA03D4, snrArray, grFFT, spikeyRatio)){
...
*/
   ...
   /* A3 spikey D1 filter */
   if (isSpikeyStringEvent(AraSim_settings->DETECTOR_STATION, dropARA03D4, snrArray, grFFT, spikeyRatio)){
