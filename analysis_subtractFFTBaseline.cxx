...
if(argc < 5){ cerr<<"Insufficient arguments. Usage: 1. Output directory 2.recoSetupFile 3. Run Number 4. FFT Baseline (pedestal) File 5. Data ROOT file 6. AraSim: more Data ROOT file. Real: Pedestal File\n"; return -1; }
...
for(int ch=0; ch<16; ch++){
   ...
   gr_median[ch] = (TGraph*)fftBaselineFile->Get(grName);
   ...
   gr_75[ch] = (TGraph*)fftBaselineFile->Get(grName);

   sprintf(grName, "gr_25_%d", ch);
   gr_25[ch] = (TGraph*)fftBaselineFile->Get(grName);
