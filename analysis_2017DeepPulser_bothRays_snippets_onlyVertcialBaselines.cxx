...
*/
   ...
   if(settings->getSkymapMode == 0){
      ...
      maxPixIdx = reconstruct3DXCorrEnvelopeGetMaxPixAndMapData_onlyVerticalBaselines(settings, cleanEvent, &clEnv, /*recoDelays*/recoBothDelays_V, recoDelays_V, /*recoDelays_H*/recoRefracDelays_V, goodChan, summary, fitsFile/*argv[5]*/, mapData/*, xCorrAroundPeakHist, sillygr*/);
      if(settings->recordMapData == 1){
