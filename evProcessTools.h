...
static TGraph *getWindowedAndPaddedEqualBeginGraph(int windowingType, TGraph *gr, const int maxSample, const double beginTime);
...
static TGraph* getCumulativeVoltageSumGraph(TGraph *gr, int startPoint=1, int endPoint = -1);
