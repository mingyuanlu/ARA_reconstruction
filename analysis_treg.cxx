...
int iterDemoCount, iterHierCoune;
double tregWeight;
...
tregTree->Branch("iterDemoCount", &iterDemoCount);
tregTree->Branch("iterHierCount", &iterHierCount);
...
for (Long64_t ev=0; ev<runEventCount/*numEntries*/; ev++){
   ...
   iterDemoCount = treg->iterDemoCount;
   iterHierCount = treg->iterHierCount;
